...
Description:
    Utility script to update dashboard gold standards with what's currently available in a given study's metadata/standards directory.
'''
...
def main():
    ...
    standards = [f for f in os.listdir(standards_path)
                    if '.json' in f]
    ...
    for s in standards:
        ...
        try:
            ...
            logger.error('Standard {} already exists in the Dashboard!'.format(s))
