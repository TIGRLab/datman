function [fMRIscan,DTInoASSET,DTIwASSET]=findSPINS_QAsenums(QAdate)
...
for l=3:length(dir2fnames)
    ...
    if ~isempty(strfind(testinfo.SeriesDescription,'Resting'))
        fMRIscan=testscannum
    elseif ~isempty(strfind(testinfo.SeriesDescription,'DTI'))
